  ...
  render() {
    ...
    return (
      <div className="line-chart-container">
        <div>
          <div className="red-confirmed-chart ">
            <Line
          ...
          <div className="blue-active-chart ">
            <Line
          ...
          <div className="green-recovered-chart ">
            <Line
          ...
          <div className="grey-deceased-chart ">
            <Line
          ...
          <div className="voilet-tested-chart ">
            <Line
          ...
          <div className="pink-tested-ratio-chart ">
            <Line
          ...
          <div className="light-pink-vaccinated-chart ">
            <Line
